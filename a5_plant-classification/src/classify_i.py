# USAGE
# ** locally: python classify.py --images dataset/images --masks dataset/masks
# ** docker: docker run --rm -v $(pwd)/src:/root opencv python classify.py --images dataset/images --masks dataset/masks

# import the necessary packages
from __future__ import print_function
from pyimagesearch.rgbhistogram import RGBHistogram
# to encode "class labels" associated with each species
# this class handles conversion of flower specifies 
from sklearn.preprocessing import LabelEncoder

# A random forest is an ensemble learning method used 
# for classification, consisting of multiple decision trees.
