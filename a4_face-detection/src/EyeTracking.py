...
# docker run --rm -v $(pwd)/src:/root opencv python EyeTracking.py --face cascades/haarcascade_frontalface_default.xml --eye cascades/haarcascade_eye.xml --video video/janyl.mov
...
while True:
    ...
    cv2.imwrite("images/output/Tracking.png", frame)
